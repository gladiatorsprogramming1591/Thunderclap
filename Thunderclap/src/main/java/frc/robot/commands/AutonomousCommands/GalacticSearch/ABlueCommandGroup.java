...
public class ABlueCommandGroup extends SequentialCommandGroup{
     ...
     * @param relDegrees 
     */
    public ABlueCommandGroup(HopperSubsystem hopper, IntakeSubsystem intake, ShooterSubsystem shooter, DriveTrainC driveTrain, TurnRelDegrees relDegrees) {
        addCommands(
            ...
            new TurnRelDegrees(driveTrain, 26.57),
